...
import { Navbar, NavbarToggler, NavbarBrand, Collapse, NavItem, Nav, NavLink, DropdownItem, DropdownMenu, UncontrolledDropdown, Input, DropdownToggle } from 'reactstrap';
        ...
        <div id="navItems">
          <UncontrolledDropdown inNavbar>
            <DropdownToggle caret nav>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16" color="white">
