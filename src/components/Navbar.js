    ...
    <div>
      <Navbar color="dark" expand="md" dark>
        ...
        <div id="navItems">
          ...
          <NavLink>
            <Link to="/hallinta">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16" color="white">
          ...
          <NavItem>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" color="white" className="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                <path
                  fillRule="evenodd"
