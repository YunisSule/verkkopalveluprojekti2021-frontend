...
import { Navbar, NavbarToggler, NavbarBrand, Collapse, NavItem, Nav, NavLink, Input, Button, InputGroup } from 'reactstrap';
    ...
    <div>
      <Navbar color="dark" expand="md" dark>
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="me-auto fs-6 fw-bold" navbar>
            <NavItem>
              <NavLink>
        ...
        <div id="navItems">
          ...
          <div id="buttons">
            ...
            {isAdmin ? (
              <NavLink>
                <Link to="/hallinta">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-gear" viewBox="0 0 16 16" color="white">
            ...
            {loggedIn ? (
              <NavItem>
                <Button id="login-modal-toggle" color="none" onClick={() => logoutUser()}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-box-arrow-in-left" viewBox="0 0 20 20">
              ...
              <NavItem>
                <Button id="login-modal-toggle" color="none" onClick={() => loginModalShow()}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" color="white" className="bi bi-box-arrow-in-right" viewBox="0 0 20 20">
