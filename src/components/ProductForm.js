    ...
    <Form>
      <Row form>
        ...
        <FormGroup>
          ...
          <Input id="image_path" name="image_path" type="text" value={formData.image_path} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
        ...
        <FormGroup>
          ...
          <Input id="category_id" name="category_id" type="text" value={formData.category_id} onChange={handleChange} />
        </FormGroup>
        <FormGroup>
